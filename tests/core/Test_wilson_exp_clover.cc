...
int main(int argc, char **argv)
{
  ...
  typedef typename CompactWilsonExpCloverFermionR::FermionField FermionField;
  ...
  CompactWilsonExpCloverFermionR Dwc(Umu, Grid, RBGrid, mass, csw_r, csw_t, cF, anis, params);
  ...
  CompactWilsonExpCloverFermionR Dwc_prime(U_prime, Grid, RBGrid, mass, csw_r, csw_t, cF, anis, params);
  ...
  std::cout << GridLogMessage << "norm diff WilsonExpClover  " << norm2(err2) << std::endl;

  std::cout << GridLogMessage << "==========================================================" << std::endl;
  std::cout << GridLogMessage << "= Testing Mooee(csw=0) Exp Clover to reproduce Mooee Wilson   " << std::endl;
  std::cout << GridLogMessage << "==========================================================" << std::endl;

  chi = Zero();
  phi = Zero();
  err = Zero();
  CompactWilsonExpCloverFermionR Dwc_csw0(Umu, Grid, RBGrid, mass, 0.0, 0.0, 1.0, anis, params); //  <-- Notice: csw=0
