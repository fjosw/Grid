...
void runBenchmark(int* argc, char*** argv) {
  ...
  typedef WilsonExpCloverFermion<WImpl> WilsonExpCloverOperator;
  typedef CompactWilsonExpCloverFermion<WImpl> CompactWilsonExpCloverOperator;
  typedef typename WilsonExpCloverOperator::FermionField Fermion;
  typedef typename WilsonExpCloverOperator::GaugeField Gauge;
  ...
  typename WilsonExpCloverOperator::ImplParams implParams;
  ...
  WilsonExpCloverOperator        Dwc(        Umu, *UGrid, *UrbGrid, mass, 0.0, csw, csw,     anisParams, implParams);
  CompactWilsonExpCloverOperator Dwc_compact(Umu, *UGrid, *UrbGrid, mass, csw, csw, cF, anisParams, implParams);
...
\
  ...
  BENCH_CLOVER_KERNEL(M);
  BENCH_CLOVER_KERNEL(Mdag);
