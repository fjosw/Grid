/*************************************************************************************
    ...
    Source file: ./lib/qcd/action/fermion/CompactWilsonExpCloverFermion.h
...
template<class Impl>
class CompactWilsonExpCloverFermion : public WilsonFermion<Impl>,
...
public:
  ...
  CompactWilsonExpCloverFermion(GaugeField& _Umu,
			    GridCartesian& Fgrid,
...
public:
  ...
  CloverDiagonalField DiagonalExp,    DiagonalExpEven,    DiagonalExpOdd;
  CloverDiagonalField DiagonalExpInv, DiagonalExpInvEven, DiagonalExpInvOdd;

  CloverTriangleField Triangle;
  CloverTriangleField TriangleExp,    TriangleExpEven,    TriangleExpOdd;
  CloverTriangleField TriangleExpInv, TriangleExpInvEven, TriangleExpInvOdd;
