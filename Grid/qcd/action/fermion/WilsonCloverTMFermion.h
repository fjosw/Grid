/*************************************************************************************
    ...
    Source file: ./lib/qcd/action/fermion/WilsonCloverTMFermion.h
...
template <class Impl>
class WilsonCloverTMFermion : public WilsonFermion<Impl>
{
public:
  // Types definitions
...
public:
  ...
  // Constructors
  WilsonCloverTMFermion(GaugeField &_Umu, GridCartesian &Fgrid,
                                                                 ...
                                                                 CloverTermInvDagOdd(&Hgrid)
  {
    ...
    if (csw_r == 0)
      std::cout << GridLogWarning << "Initializing WilsonCloverTMFermion with csw_r = 0" << std::endl;
    if (csw_t == 0)
      std::cout << GridLogWarning << "Initializing WilsonCloverTMFermion with csw_t = 0" << std::endl;
