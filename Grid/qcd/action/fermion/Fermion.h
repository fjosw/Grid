...
// CloverTM fermions
typedef WilsonCloverTMFermion<WilsonImplR> WilsonCloverTMFermionR;
typedef WilsonCloverTMFermion<WilsonImplF> WilsonCloverTMFermionF;
typedef WilsonCloverTMFermion<WilsonImplD> WilsonCloverTMFermionD;

typedef WilsonCloverTMFermion<WilsonAdjImplR> WilsonCloverTMAdjFermionR;
typedef WilsonCloverTMFermion<WilsonAdjImplF> WilsonCloverTMAdjFermionF;
typedef WilsonCloverTMFermion<WilsonAdjImplD> WilsonCloverTMAdjFermionD;

typedef WilsonCloverTMFermion<WilsonTwoIndexSymmetricImplR> WilsonCloverTMTwoIndexSymmetricFermionR;
typedef WilsonCloverTMFermion<WilsonTwoIndexSymmetricImplF> WilsonCloverTMTwoIndexSymmetricFermionF;
typedef WilsonCloverTMFermion<WilsonTwoIndexSymmetricImplD> WilsonCloverTMTwoIndexSymmetricFermionD;

typedef WilsonCloverTMFermion<WilsonTwoIndexAntiSymmetricImplR> WilsonCloverTMTwoIndexAntiSymmetricFermionR;
typedef WilsonCloverTMFermion<WilsonTwoIndexAntiSymmetricImplF> WilsonCloverTMTwoIndexAntiSymmetricFermionF;
typedef WilsonCloverTMFermion<WilsonTwoIndexAntiSymmetricImplD> WilsonCloverTMTwoIndexAntiSymmetricFermionD;
