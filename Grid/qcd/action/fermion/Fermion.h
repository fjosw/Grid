...
// Compact ExpClover fermions
typedef CompactWilsonExpCloverFermion<WilsonImplR> CompactWilsonExpCloverFermionR;
typedef CompactWilsonExpCloverFermion<WilsonImplF> CompactWilsonExpCloverFermionF;
typedef CompactWilsonExpCloverFermion<WilsonImplD> CompactWilsonExpCloverFermionD;

typedef CompactWilsonExpCloverFermion<WilsonAdjImplR> CompactWilsonExpCloverAdjFermionR;
typedef CompactWilsonExpCloverFermion<WilsonAdjImplF> CompactWilsonExpCloverAdjFermionF;
typedef CompactWilsonExpCloverFermion<WilsonAdjImplD> CompactWilsonExpCloverAdjFermionD;

typedef CompactWilsonExpCloverFermion<WilsonTwoIndexSymmetricImplR> CompactWilsonExpCloverTwoIndexSymmetricFermionR;
typedef CompactWilsonExpCloverFermion<WilsonTwoIndexSymmetricImplF> CompactWilsonExpCloverTwoIndexSymmetricFermionF;
typedef CompactWilsonExpCloverFermion<WilsonTwoIndexSymmetricImplD> CompactWilsonExpCloverTwoIndexSymmetricFermionD;

typedef CompactWilsonExpCloverFermion<WilsonTwoIndexAntiSymmetricImplR> CompactWilsonExpCloverTwoIndexAntiSymmetricFermionR;
typedef CompactWilsonExpCloverFermion<WilsonTwoIndexAntiSymmetricImplF> CompactWilsonExpCloverTwoIndexAntiSymmetricFermionF;
typedef CompactWilsonExpCloverFermion<WilsonTwoIndexAntiSymmetricImplD> CompactWilsonExpCloverTwoIndexAntiSymmetricFermionD;
